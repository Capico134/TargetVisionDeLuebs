...
PARAMETER_LEXIKON = {
    ...
    "abriss_min_hebel": "Stabilitäts-Netz für die Abrisskante. Misst den Abstand (Hebel) in Pixeln zwischen der gefundenen Papierkante und dem Schwerpunkt des Risses. Ist dieser Abstand kleiner als X Pixel (z.B. 3.0), ist der Riss zu klein für eine stabile Richtungspeilung und wird ignoriert.",
